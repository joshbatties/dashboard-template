...
// Freeze the initial time so that both server and client use the same value
...
function PerformanceChart() {
  // Generate consistent (deterministic) random bar values using a seeded random generator
  const bars = useMemo(() => {
